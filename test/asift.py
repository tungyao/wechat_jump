...
# local modules
from wechat_jump.libs.common import Timer
from wechat_jump.libs.find_obj import init_feature, filter_matches, explore_match
...
def affine_skew(tilt, phi, img, mask=None):
    ...
    if tilt != 1.0:
        ...
        img = cv2.resize(img, (500, 700), fx=1.0/tilt, fy=1.0, interpolation=cv2.INTER_NEAREST)
        A[0] /= tilt
